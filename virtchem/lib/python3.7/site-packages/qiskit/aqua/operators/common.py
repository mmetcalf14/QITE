...
def evolution_circuit(pauli_list, evo_time, num_time_slices,
                          controlled=False, power=1,
                          use_basis_gates=True, shallow_slicing=False,
                          barrier=False, reg_name = 'q0'):
    """
    ...
    state_registers = QuantumRegister(pauli_list[0][1].numberofqubits, name=reg_name)
    print(state_registers)
    if controlled:
    ...
    print('cnot pairs: ',cnot_qubit_pairs)
